...
#define AM_GOBIGKEY	sf::Keyboard::Num0
#define AM_FOLLOWKEY	sf::Keyboard::F
#define AM_GRIDKEY	sf::Keyboard::G
#define AM_MARKKEY	sf::Keyboard::M
#define AM_CLEARMARKKEY	sf::Keyboard::C
