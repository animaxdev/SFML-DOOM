...
namespace DoomLib
{
    ...
    void						SetCurrentMapName(const std::string& name ) { currentMapName = name; }
    const std::string &				GetCurrentMapName() { return currentMapName; }
    void						SetCurrentDifficulty( const std::string& name ) { currentDifficulty = name; }
    const std::string &				GetCurrentDifficulty() { return currentDifficulty; }
